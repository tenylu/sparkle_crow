...
export async function setupFirewall(): Promise<void> {
  ...
  const removeCommand = `
  $rules = @("mihomo", "mihomo-alpha", "CrowVPN")
  ...
  New-NetFirewallRule -DisplayName "CrowVPN" -Direction Inbound -Action Allow -Program "${exePath()}" -Enabled True -Profile Any -ErrorAction SilentlyContinue
  `
